...
int main(){
    Player account("Kacy", 0, 0, 0, 0, 50); // Name | LvL | Exp | Bonus to HP | Bonus to DMG | Money
...
Player shop(Player account)
{
    ...
    std::cout << "[ [1] 5 x Heal Potion's ]   - [ 50$ ]" << std::endl;
    std::cout << "[ [2] 5 x Damage Potion's ] - [ 80$ ]" << std::endl << std::endl;
    ...
    else
    {
        if(option == 1)
        {
            if(account.getPlayerMoney() >= 50)
            {
                std::cout << "[ Buying 5 x Heal Potion's ]" << std::endl;
                potion1.setPotionQuantity(potion1.getPotionQuantity() + 5);
                account.setPlayerMoney(account.getPlayerMoney() - 50);
                system("pause");
                system("cls");
                return account;
            }
        ...
        else
        {
            if(option == 2)
            {
                if(account.getPlayerMoney() >= 80)
                {
                    std::cout << "[ Buying 5 x Damage Potion's ]" << std::endl;
                    potion2.setPotionQuantity(potion2.getPotionQuantity() + 5);
                    account.setPlayerMoney(account.getPlayerMoney() - 80);
                    system("pause");
                    system("cls");
                    return account;
                }
                ...
                if(option == "I" || option == "i") // TODO //
                    {
                        ...
                        std::cout << " [1] " << potion2.getPotionName() << " x " << potion2.getPotionQuantity() << std::endl;
