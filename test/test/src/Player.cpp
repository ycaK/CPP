...
Player::Player(std::string name, int lvl, int exp, int lvHp, int lvDmg){Player::setPlayerName(name); Player::setPlayerLvl(lvl); Player::setPlayerExp(exp); Player::setPlayerLvlHp(lvHp); Player::setPlayerLvlDmg(lvDmg);}
